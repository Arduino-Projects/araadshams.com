...
import type { Education as EducationType } from '@/types/experience'
...
export function Education({
  ...
  const formattedEndDate = dayjs(endDate).format('MMM YYYY')
    ...
    <div className="group rounded-lg border border-secondary/20 p-6 transition-colors hover:border-secondary/40">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h3 className="text-lg font-semibold text-primary">{school}</h3>
